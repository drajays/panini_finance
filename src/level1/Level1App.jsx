...
function Sidebar({ active, setActive, open, setOpen, completedCount, onSwitchToL2 }) {
  return (
    <>
      ...
      <aside className={`sidebar ${open ? "open" : ""}`}>
        ...
        <button className="ghost-button level-switch" onClick={onSwitchToL2} style={{ margin: "0 4px 18px", width: "calc(100% - 8px)", justifyContent: "center" }}>
          Switch to Level II →
        </button>
...
export default function Level1App({ onSwitchToL2 }) {
  ...
  return (
    <div className="level1-root">
      <div className="app-shell">
        <Sidebar active={active} setActive={goTo} open={sidebarOpen} setOpen={setSidebarOpen} completedCount={completed.length} onSwitchToL2={onSwitchToL2} />
